...
```
SCREENSHOT_NAME="A_Demonstration_of_Darktable_Masks_-_Darktable_Tutorial_07"
mpv --screenshot-template="${SCREENSHOT_NAME}-%wM:%wS" --screenshot-jpeg-quality=70 https://youtu.be/SKknBy5lX7I
